...
import StyledPegaExtensionsLayoutWrapper, { StyledDetailsGridContainer, StyledHighlightedFieldsHrLine } from './styles';

// includes in bundle
import { getAllFields } from './utils';

// interface for props
interface PegaExtensionsLayoutProps extends PConnFieldProps {
...
function PegaExtensionsLayout(props: PegaExtensionsLayoutProps) {
  ...
  return (
    <StyledPegaExtensionsLayoutWrapper>
...
export default withConfiguration(PegaExtensionsLayout);
