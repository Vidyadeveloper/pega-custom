...
import PegaExtensionsLayout from './index';
...
const meta: Meta<typeof PegaExtensionsLayout> = {
  title: 'PegaExtensionsLayout',
  component: PegaExtensionsLayout,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaExtensionsLayout>;
...
export const BasePegaExtensionsLayout: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <PegaExtensionsLayout {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
    </PegaExtensionsLayout>
  );
};

BasePegaExtensionsLayout.args = {
  showLabel: true,
