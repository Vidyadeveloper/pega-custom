...
import PegaConstellationUiGalleryL1Details from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryL1Details> = {
  title: 'PegaConstellationUiGalleryL1Details',
  component: PegaConstellationUiGalleryL1Details,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL1Details>;
...
export const BasePegaConstellationUiGalleryL1Details: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <PegaConstellationUiGalleryL1Details {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </PegaConstellationUiGalleryL1Details>
    </>
  );
};

BasePegaConstellationUiGalleryL1Details.args = {
  showLabel: true,
