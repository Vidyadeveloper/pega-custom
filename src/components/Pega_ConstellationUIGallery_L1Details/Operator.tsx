...
// interface for props
interface PegaConstellationUiGalleryL1DetailsOperatorProps extends PConnFieldProps {
...
function Operator(props: PegaConstellationUiGalleryL1DetailsOperatorProps) {
