...
import StyledPegaConstellationUiGalleryL1FrWrapper from './styles';

// interface for props
interface PegaConstellationUiGalleryL1FrProps extends PConnFieldProps {
...
function PegaConstellationUiGalleryL1Fr(props: PegaConstellationUiGalleryL1FrProps) {
  ...
  if ((readOnly && readOnly === true) || (displayMode && displayMode === 'DISPLAY_ONLY')) {
    return (
      <StyledPegaConstellationUiGalleryL1FrWrapper>
...
export default withConfiguration(PegaConstellationUiGalleryL1Fr);
