...
import PegaConstellationUiGalleryL1Fr from './index';
...
const meta: Meta<typeof PegaConstellationUiGalleryL1Fr> = {
  title: 'PegaConstellationUiGalleryL1Fr',
  component: PegaConstellationUiGalleryL1Fr,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'TwoColumnForm'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL1Fr>;
...
export const BasePegaConstellationUiGalleryL1Fr: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <PegaConstellationUiGalleryL1Fr {...props} {...args}>
      {[regionAChildren, regionBChildren]}
    </PegaConstellationUiGalleryL1Fr>
  );
};

BasePegaConstellationUiGalleryL1Fr.args = {
  readOnly: false,
  showLabel: true,
