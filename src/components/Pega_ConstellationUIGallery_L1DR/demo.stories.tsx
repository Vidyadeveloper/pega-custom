...
import PegaConstellationUiGalleryL1Dr from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryL1Dr> = {
  title: 'PegaConstellationUiGalleryL1Dr',
  component: PegaConstellationUiGalleryL1Dr,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL1Dr>;
...
export const BasePegaConstellationUiGalleryL1Dr: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <PegaConstellationUiGalleryL1Dr {...props} {...args}>
      <Region
        {...{
          getPConnect: () => ({
            setInheritedProp: () => {},
      ...
      />
    </PegaConstellationUiGalleryL1Dr>
  );
};

BasePegaConstellationUiGalleryL1Dr.args = {
  showLabel: true,
