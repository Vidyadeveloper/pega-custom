...
import PegaConstellationUiGalleryLtdr from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryLtdr> = {
  title: 'PegaConstellationUiGalleryLtdr',
  component: PegaConstellationUiGalleryLtdr,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryLtdr>;
...
export const BasePegaConstellationUiGalleryLtdr: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <PegaConstellationUiGalleryLtdr {...props} {...args}>
      <Region
        {...{
          getPConnect: () => ({
            setInheritedProp: () => {},
      ...
      />
    </PegaConstellationUiGalleryLtdr>
  );
};

BasePegaConstellationUiGalleryLtdr.args = {
  showLabel: true,
