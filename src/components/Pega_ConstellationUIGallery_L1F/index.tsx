...
import StyledPegaConstellationUiGalleryL1FWrapper from './styles';

// interface for props
interface PegaConstellationUiGalleryL1FProps extends PConnFieldProps {
...
function PegaConstellationUiGalleryL1F(props: PegaConstellationUiGalleryL1FProps) {
  const {
    children = [],
    NumCols = '1',
    label,
  ...
  if ((readOnly && readOnly === true) || (displayMode && displayMode === 'DISPLAY_ONLY')) {
    ...
    return (
      <StyledPegaConstellationUiGalleryL1FWrapper>
...
export default withConfiguration(PegaConstellationUiGalleryL1F);
