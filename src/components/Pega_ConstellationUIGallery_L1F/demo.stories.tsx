...
import PegaConstellationUiGalleryL1F from './index';
...
const meta: Meta<typeof PegaConstellationUiGalleryL1F> = {
  title: 'PegaConstellationUiGalleryL1F',
  component: PegaConstellationUiGalleryL1F,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Form'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL1F>;
...
export const BasePegaConstellationUiGalleryL1F: Story = args => {
  const { readOnly } = args;
  ...
  return (
    <>
      <PegaConstellationUiGalleryL1F {...props} {...args}>
        {regionAChildren}
      </PegaConstellationUiGalleryL1F>
    </>
  );
};

BasePegaConstellationUiGalleryL1F.args = {
  readOnly: false,
  showLabel: true,
  label: 'Form template',
  NumCols: 1
