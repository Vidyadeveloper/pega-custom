...
import PegaConstellationUiGalleryLdr from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryLdr> = {
  title: 'PegaConstellationUiGalleryLdr',
  component: PegaConstellationUiGalleryLdr,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryLdr>;
...
export const BasePegaConstellationUiGalleryLdr: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <PegaConstellationUiGalleryLdr {...props} {...args}>
      <Region
        {...{
          getPConnect: () => ({
            setInheritedProp: () => {},
      ...
      />
    </PegaConstellationUiGalleryLdr>
  );
};

BasePegaConstellationUiGalleryLdr.args = {
  showLabel: true,
