...
import StyledPegaConstellationUiGalleryLdrWrapper, {
...
// interface for props
interface PegaConstellationUiGalleryLdrProps extends PConnFieldProps {
...
function PegaConstellationUiGalleryLdr(props: PegaConstellationUiGalleryLdrProps) {
  ...
  return (
    <StyledPegaConstellationUiGalleryLdrWrapper>
...
export default withConfiguration(PegaConstellationUiGalleryLdr);
