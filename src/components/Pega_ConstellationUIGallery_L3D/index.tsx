...
import StyledPegaConstellationUiGalleryL3DWrapper, {
...
// interface for props
interface PegaConstellationUiGalleryL3DProps extends PConnFieldProps {
...
function PegaConstellationUiGalleryL3D(props: PegaConstellationUiGalleryL3DProps) {
  ...
  return (
    <StyledPegaConstellationUiGalleryL3DWrapper>
...
export default withConfiguration(PegaConstellationUiGalleryL3D);
