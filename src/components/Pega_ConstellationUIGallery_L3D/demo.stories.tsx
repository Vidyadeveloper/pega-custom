...
import PegaConstellationUiGalleryL3D from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryL3D> = {
  title: 'PegaConstellationUiGalleryL3D',
  component: PegaConstellationUiGalleryL3D,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL3D>;
...
export const BasePegaConstellationUiGalleryL3D: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <PegaConstellationUiGalleryL3D {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </PegaConstellationUiGalleryL3D>
    </>
  );
};

BasePegaConstellationUiGalleryL3D.args = {
  showLabel: true,
