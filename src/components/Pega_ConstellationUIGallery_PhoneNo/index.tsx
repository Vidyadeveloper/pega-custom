...
import { getCountryDisplay } from './country-flags';
...
function PegaConstellationUiGalleryPhoneNo(props: PegaConstellationUiGalleryPhoneNoProps) {
  ...
  const callingCodesList = datasource?.source?.map((item: any) => ({
    ...item,
    displayValue: getCountryDisplay(item.value, item.displayValue)
  })) || [
    // Default fallbacks
    { value: '+1', displayValue: getCountryDisplay('+1') },
    { value: '+91', displayValue: getCountryDisplay('+91') }
  ];
