...
import StyledPegaConstellationUiGalleryL2DetailsWrapper, {
...
// interface for props
interface PegaConstellationUiGalleryL2DetailsProps extends PConnFieldProps {
...
function PegaConstellationUiGalleryL2Details(props: PegaConstellationUiGalleryL2DetailsProps) {
  ...
  return (
    <StyledPegaConstellationUiGalleryL2DetailsWrapper>
...
export default withConfiguration(PegaConstellationUiGalleryL2Details);
