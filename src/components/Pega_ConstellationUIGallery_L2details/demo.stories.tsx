...
import PegaConstellationUiGalleryL2Details from './index';
import {
  pyReviewRaw,
  pyReviewResolved,
...
const meta: Meta<typeof PegaConstellationUiGalleryL2Details> = {
  title: 'PegaConstellationUiGalleryL2Details',
  component: PegaConstellationUiGalleryL2Details,
  excludeStories: /.*Data$/,
  parameters: {
    type: 'Details'
  }
...
export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL2Details>;
...
export const BasePegaConstellationUiGalleryL2Details: Story = (args: any) => {
  const props = {
    getPConnect: () => {
      return {
        getChildren: () => {
  ...
  return (
    <>
      <PegaConstellationUiGalleryL2Details {...props} {...args}>
        <Region
          {...{
            getPConnect: () => ({
              setInheritedProp: () => {},
        ...
        />
      </PegaConstellationUiGalleryL2Details>
    </>
  );
};

BasePegaConstellationUiGalleryL2Details.args = {
  showLabel: true,
