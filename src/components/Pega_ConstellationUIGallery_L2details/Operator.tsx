...
// interface for props
interface PegaConstellationUiGalleryL2DetailsOperatorProps extends PConnFieldProps {
...
function Operator(props: PegaConstellationUiGalleryL2DetailsOperatorProps) {
