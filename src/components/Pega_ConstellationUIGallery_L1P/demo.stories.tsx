...
import PegaConstellationUiGalleryL1P from './index';
import { pyHome1Resolved, pyHome1Raw } from './mock';

const meta: Meta<typeof PegaConstellationUiGalleryL1P> = {
  title: 'PegaConstellationUiGalleryL1P',
  component: PegaConstellationUiGalleryL1P,
  excludeStories: /.*Data$/
};

export default meta;
type Story = StoryObj<typeof PegaConstellationUiGalleryL1P>;

export const BasePegaConstellationUiGalleryL1P: Story = (args: any) => {
  if (!window.PCore) {
    window.PCore = {} as any;
  }
  ...
  return (
    <>
      <PegaConstellationUiGalleryL1P {...props} {...args}>
        {regionAChildren}
      </PegaConstellationUiGalleryL1P>
    </>
  );
};

BasePegaConstellationUiGalleryL1P.args = {
  title: 'Page Template',
