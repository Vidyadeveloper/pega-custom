...
// interface for props
interface PegaConstellationUiGalleryL1PWorkProps extends PConnFieldProps {
  // If any, enter additional props that only exist on TextInput here
  variant: any;
}

export default function GetNextWork(props: PegaConstellationUiGalleryL1PWorkProps) {
